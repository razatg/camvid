    ...
    if (this.props.formp === "movable" ){
      ...
      return(
        ...
        <WebView
              javaScriptEnabled = {true}
              //source = {{ uri: this.state.url }}
              source={{ html: '<html><meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" name="viewport" /><iframe src="'+ this.props.vUrl +'" + "?autoplay=1&mute=1&modestbranding=0&playsinline=0&showinfo=0&rel=0" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%"></iframe></html>'}} 
             />: <View></View>}
        </View>
      );
    }
